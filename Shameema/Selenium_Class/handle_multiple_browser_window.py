...
class HandleBrowserTabs:
    ...
    def get_element(self,locator, cond = ec.invisibility_of_element_located):
    ...
    def login_to_hrm_website(self):
        ...
        self.get_element(locator=(By.XPATH,"//*[contains(., 'Login')]"),  cond = ec.element_to_be_clickable).click()
        time.sleep(10)
