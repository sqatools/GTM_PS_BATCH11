...
class Fblogin:
    ...
    #     self.click_ele(locator=(By.NAME,"//button[@name='login']"),cond=ec.element_to_be_clickable)
    #     time.sleep(20)
    ...
    def create_ac(self):
        ...
        time.sleep(5)
        self.enter_data(locator=(By.XPATH, "//div[text( )='Mobile number or email address']"),value='testemail@email.com',cond=ec.element_to_be_clickable)
        time.sleep(10)
