...
class Homework:
    ...
    def bus_booking(self):
        ...
        # self.click_element(locator=(By.XPATH, "(//span[text()='4C']//parent::span//parent::div//parent::div)[1]"))
        ...
        self.get_element(locator=(By.XPATH, "//input[@placeholder='Enter Full Name']")).send_keys(("automation tester"))
        self.get_element(locator=(By.XPATH, "//input[@placeholder='Age']")).send_keys(("30"))
        self.click_element(locator=(By.XPATH, '//*[text()="Male"]//parent::li'))
        ...
        self.click_element(locator=(By.XPATH,"//*[@id='confirm_check']//parent::span"))
        # self.click_element(locator=(By.XPATH,"//input[@id='confirm_check']"))
        # self.click_element(locator=(By.XPATH,"//input[@type='checkbox']"))
        self.click_element(locator=(By.XPATH,"//button[contains(@class,'PayButton')]"))
