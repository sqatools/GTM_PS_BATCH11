...
class HRM:
    ...
    def leave(self):
            ...
            self.get_click((By.XPATH, "//div[contains(text(),'12')]"))
            self.get_click((By.XPATH, "//input[@placeholder='yyyy-dd-mm'])[2]"))
            self.get_click((By.XPATH, "//div[contains(text(),'15')]"))
            time.sleep(3)
    ...
    def Recruitment(self):
        self.get_click((By.XPATH,"//span[text()='Recruitment']"))
        self.get_click((By.XPATH,"//label[text()='Job Title']//ancestor::div[contains(@class, 'oxd-grid-item')]//div[contains(text(), 'Select')]"))
        time.sleep(3)
        self.get_click((By.XPATH,"//span[normalize-space()='Automaton Tester']"))
        self.get_click((By.XPATH,"//label[text()='Vacancy']//ancestor::div[contains(@class, 'oxd-grid-item')]//div[contains(text(), 'Select')]"))
        self.get_click((By.XPATH, "//span[normalize-space()='Senior QA Lead']"))
        self.get_click((By.XPATH,"//label[text()='Hiring Manager']//ancestor::div[contains(@class, 'oxd-grid-item')]//div[contains(text(), 'Select')]"))
        self.get_click((By.XPATH, "//span[contains(text(),'manda user')]"))
        self.get_click((By.XPATH,"//label[text()='Status']//ancestor::div[contains(@class, 'oxd-grid-item')]//div[contains(text(), 'Select')]"))
        self.get_click((By.XPATH, "//span[normalize-space()='Application Initiated']"))
        self.get_click((By.XPATH,"//input[@placeholder='From']"))
        self.get_click((By.XPATH,"//div[@class='oxd-calendar-date'][normalize-space()='18']"))
        self.get_click((By.XPATH, "//input[@placeholder='To']"))
        self.get_click((By.XPATH, "//div[@class='oxd-calendar-date'][normalize-space()='28']"))
        self.get_click((By.XPATH,"//label[text()='Method of Application']//ancestor::div[contains(@class, 'oxd-grid-item')]//div[contains(text(), 'Select')]"))
        self.get_click((By.XPATH, "//div[@role='listbox']//*[contains(text(),'Manual')]"))
        self.get_click((By.XPATH, " //button[normalize-space()='Search'] "))
        time.sleep(3)
